    ...
    <div className="flex min-h-[80vh] items-center justify-center p-4">
      <Container size="form">
        <Card className="space-y-5 p-6 text-center shadow-level2 sm:p-8">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#E8D9BF]/50 text-[#2457A6]">
            <Compass className="h-7 w-7 stroke-[1.75]" />
          </div>

          <div className="space-y-1.5">
            <p className="font-serif text-[13px] font-medium text-[#D9822B]">मार्गभ्रंशः • ४०४</p>

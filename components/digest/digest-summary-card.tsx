...
export function DigestSummaryCard({ summary, formattedRange }: DigestSummaryCardProps) {
  return (
    <Card className="border-[rgba(63,148,149,0.16)] bg-white p-5 shadow-level2 sm:p-7">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[rgba(63,148,149,0.12)] pb-4">
        <div className="flex items-center gap-2">
          <Calendar className="h-4 w-4 text-[#A9824D]" />
          <span className="text-[12px] font-bold uppercase tracking-wider text-[#547070]">
            Weekly Group Snapshot
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[13px] font-bold text-[#193B3B]">{formattedRange}</span>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
        ...
        <div className="rounded-2xl border border-[rgba(63,148,149,0.14)] bg-[#F7F5EF]/60 p-3.5 sm:p-4">
          <div className="flex items-center gap-2 text-[12px] font-semibold text-[#547070]">
            <Users className="h-4 w-4 text-[#3F9495]" />
            <span>Reported</span>
          </div>
          <div className="mt-2 flex items-baseline gap-1.5">
            <span className="text-[22px] font-bold text-[#193B3B] sm:text-[26px]">
              {summary.studentsReportedCount}
            </span>
            <span className="text-[13px] font-medium text-[#547070]">
        ...
        <div className="rounded-2xl border border-[rgba(63,148,149,0.14)] bg-[#F7F5EF]/60 p-3.5 sm:p-4">
          <div className="flex items-center gap-2 text-[12px] font-semibold text-[#547070]">
            <CheckCircle className="h-4 w-4 text-[#328A7A]" />
        ...
        <div className="rounded-2xl border border-[rgba(63,148,149,0.14)] bg-[#F7F5EF]/60 p-3.5 sm:p-4">
          <div className="flex items-center gap-2 text-[12px] font-semibold text-[#547070]">
            <AlertCircle className="h-4 w-4 text-[#A9824D]" />
            <span>Attention</span>
          </div>
          <div className="mt-2 flex items-baseline gap-1">
            <span className="text-[22px] font-bold text-[#193B3B] sm:text-[26px]">
            ...
            <span className="text-[12px] font-medium text-[#547070]">

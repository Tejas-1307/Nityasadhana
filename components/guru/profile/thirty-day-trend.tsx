      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-2xl border border-[rgba(63,148,149,0.14)] bg-[#F7F5EF]/60 p-3.5">
            ...
            <div className="mt-1 text-[20px] font-bold text-[#193B3B]">
              {stats.totalSubmitted} / 30
            </div>
            <span className="text-[10px] text-[#547070]">Days recorded</span>
          </div>
          ...
          <div className="rounded-2xl border border-[rgba(63,148,149,0.14)] bg-[#F7F5EF]/60 p-3.5">
            ...
            <span className="text-[10px] text-[#547070]">Daily average</span>
          </div>
          ...
          <div className="rounded-2xl border border-[rgba(63,148,149,0.14)] bg-[#F7F5EF]/60 p-3.5">
            ...
            <span className="text-[10px] text-[#547070]">Typical time</span>
          </div>
          ...
          <div className="rounded-2xl border border-[rgba(63,148,149,0.14)] bg-[#F7F5EF]/60 p-3.5">
            ...
            <span className="text-[10px] text-[#547070]">Reading &amp; hearing</span>
          </div>
        </div>
      </div>
    </Card>

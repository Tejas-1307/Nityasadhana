...
export function FluteMotif({ size = 36, className, ...props }: MotifProps) {
  return (
    ...
    >
      ...
      />
      {/* Flute Holes */}
      <circle cx="28" cy="35" r="1.5" fill="#193B3B" />
      <circle cx="34" cy="30.5" r="1.5" fill="#193B3B" />
      <circle cx="40" cy="25.5" r="1.5" fill="#193B3B" />
      <circle cx="46" cy="20.5" r="1.5" fill="#193B3B" />
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <ellipse cx="55" cy="14" rx="2" ry="3" fill="#A9824D" transform="rotate(-30 55 14)" />
    </svg>
  );
}
...
export function ShriKrishnaEditorialArt({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle,rgba(169,130,77,0.18)_0%,rgba(63,148,149,0.10)_50%,rgba(234,247,244,0)_75%)] blur-md" />
      ...
      >
        ...
        <circle cx="60" cy="58" r="46" stroke="#D8F1EE" strokeWidth="1" strokeDasharray="3 3" />
        <circle cx="60" cy="58" r="42" stroke="#A9824D" strokeWidth="0.75" strokeOpacity="0.4" />
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <ellipse cx="67" cy="18" rx="2.5" ry="4" fill="#A9824D" transform="rotate(-25 67 18)" />
        ...
        />
        {/* Tilak */}
        <path d="M59 34V39" stroke="#A9824D" strokeWidth="1.5" strokeLinecap="round" />
        ...
        />
        {/* Flute Ornaments */}
        <circle cx="56" cy="58" r="1.5" fill="#193B3B" />
        <circle cx="63" cy="54" r="1.5" fill="#193B3B" />
        <circle cx="70" cy="50" r="1.5" fill="#193B3B" />

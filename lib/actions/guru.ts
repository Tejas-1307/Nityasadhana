...
export async function getGuruShishyaDetailAction(shishyaId: string): Promise<any> { return { success: true, data: await api.get<any>(`/api/guru/shishyas/${shishyaId}/reports`) }; }
